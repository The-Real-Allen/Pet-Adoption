      ...
      <motion.div   className="home1-container">
        <div className="home1-left ms-3">
          <div className="  font-weight-bold">
            <motion.h3  initial={{ x: "-100%"}} animate={{x:"0"}} exit={{x:"100%"}} transition={{duration:"0.4",}} className="mt-4 py-2">
          ...
          <div>
            <motion.p  initial={{ x: "-100%"}} animate={{x:"0"}} exit={{x:"100%"}} transition={{duration:"0.8",}}  className="pt-3">
